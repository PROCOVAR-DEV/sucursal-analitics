...
export default function UploadPanel({ sourceId, onSelect, onRefresh }) {
  ...
  return (
    /*
      Ya no es la columna de la izquierda: ahora se abre a ancho completo, encima del
      contenido, cuando alguien pide cargar un reporte a mano. Por eso lleva su propio
      borde y su redondeo — antes se apoyaba en el borde del sidebar, que ya no existe.
    */
    <aside className="w-full rounded-xl border border-slate-200 bg-white flex flex-col">
      {/* Cabecera solo móvil: colapsa la lista de archivos. */}
      <button
        type="button"
